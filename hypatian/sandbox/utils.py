"""hypatian.sandbox.utils."""


def pair(relation, human_readable=None):
	"""Create a dictionary pair of a relation uri in string form and a human readable equivalent.

	:param relation: This should be preformated so generate_uri works on it
	:type relation: str
	:param human_readable: a plain-text description of the uri
